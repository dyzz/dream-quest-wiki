...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Magical</h1>
    <p class="dq-lede">获得 2 点法力。</p>
    <p class="dq-original">原文：Gain 2 mana</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Mana1__461.png" alt="Magical" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Mana1</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Magical</em></span>
