---
title: "双足飞龙"
description: "普通怪物，出现在 地牢、森林、山脉。等级范围 1-4 级。基础牌组 6 张。主要依靠牌组行动。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>双足飞龙</h1>
    <span class="dq-original">原名：Wyvern</span>
    <p class="dq-lede">普通怪物，出现在 地牢、森林、山脉。等级范围 1-4 级。基础牌组 6 张。主要依靠牌组行动。等级提升会改动牌组或属性。</p>
...
<span>山脉</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Wyvern__669.png" alt="双足飞龙" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>双足飞龙</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Wyvern</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Wyvern</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Wyvern</em></span>
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-wyvern-1">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/wyvern">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Wyvern__669.png" alt="双足飞龙" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>双足飞龙</strong><small>Wyvern</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>1</em></span><span><b>HP</b><em>4</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/infect1" title="感染（1）">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Infect1__754.png" alt="感染（1）" loading="eager"></span></span>
...
<tr id="snapshot-wyvern-2">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/wyvern">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Wyvern__669.png" alt="双足飞龙" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>双足飞龙</strong><small>Wyvern</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>2</em></span><span><b>HP</b><em>7</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
...
<tr id="snapshot-wyvern-3">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/wyvern">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Wyvern__669.png" alt="双足飞龙" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>双足飞龙</strong><small>Wyvern</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>3</em></span><span><b>HP</b><em>10</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
...
<tr id="snapshot-wyvern-4">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/wyvern">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Wyvern__669.png" alt="双足飞龙" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>双足飞龙</strong><small>Wyvern</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>4</em></span><span><b>HP</b><em>15</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/infect2" title="感染（2）">
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-wyvern-1">查看全量怪物等级快照</a></p>
</section>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/infect1">
  ...
  <strong>感染（1）</strong>
  <span class="dq-profession-card-meta">Infect (1) · 基础牌组 x3 / 关键行为 / 等级变化 / 机制引用 / 等级移出 / 机制参数</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Infect1__754.png" alt="感染（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>感染（1）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/infect2">
  ...
  <strong>感染（2）</strong>
  <span class="dq-profession-card-meta">Infect (2) · 等级变化 / 机制引用 / 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Infect2__650.png" alt="感染（2）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>感染（2）</strong>
