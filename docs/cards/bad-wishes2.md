---
title: "三个愿望（2）"
description: "强化 Three Wishes：随机展示 3 个更强惩罚候选，由玩家选择 1 个结算；伤害、中毒和扣行动点惩罚更高。"
---


<section class="dq-card-hero">
<div class="dq-card-art-panel">
<span class="dq-game-card dq-game-card-hero"><img src="/assets/extracted/textures/by_container/resources/BadWishes2__1020.png" alt="三个愿望（2）" loading="lazy"></span>
</div>
  <div class="dq-card-info-panel">
    <p class="dq-kicker">行动牌 · 6 阶</p>
    <h1>三个愿望（2）</h1>
    <span class="dq-original">原名：Three Wishes</span>
    <div class="dq-status-row"><span class="dq-status-badge dq-status-monster" title="怪物限定来源：灯神 优先起手、灯神 关键行为、灯神 等级变化。">怪物限定</span></div>
    <p class="dq-rules dq-card-rules-fixed">给对手三个选项，由对手选择其中一个。</p>
...
<a class="dq-button dq-button-secondary" href="/cards/bad-wishes">上一张</a>
<a class="dq-button dq-button-secondary" href="/cards/focus">下一张</a>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>三个愿望（2）</em></span>
<span title="游戏原始显示名；没有显示名时使用内部类名拆分。"><strong>英文名</strong><em>Three Wishes</em></span>
<span title="怪物限定来源：灯神 优先起手、灯神 关键行为、灯神 等级变化。"><strong>卡牌状态</strong><em>怪物限定</em></span>
<span title="对卡牌状态的具体解释，帮助区分普通玩家牌、职业特色牌、成就牌和怪物专用牌。"><strong>状态说明</strong><em>怪物限定来源：灯神 优先起手、灯神 关键行为、灯神 等级变化。</em></span>
<span title="游戏数据里用于引用这张牌的内部标识。"><strong>内部名称</strong><em>BadWishes2</em></span>
<span title="反编译数据中的类名，通常也是最稳定的检索名称。"><strong>类名</strong><em>BadWishes2</em></span>
