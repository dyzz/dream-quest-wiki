...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Equipped</h1>
    <p class="dq-lede">获得 1 个装备槽。</p>
    <p class="dq-original">原文：Gain one equipment slot</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/EquipSlot__458.png" alt="Equipped" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>EquipSlot</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Equipped</em></span>
...
<tr>
  <td>ApplyTo</td>
  <td>调用</td>
  <td>DungeonPlayer.GainEquipSlot</td>
  <td>-</td>
</tr>
  </tbody>
</table>
