---
title: "美杜莎"
description: "普通怪物，出现在 森林、地牢、山脉。等级范围 4-7 级。基础牌组 6 张。主要依靠牌组行动。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>美杜莎</h1>
    <span class="dq-original">原名：Medusa</span>
    <p class="dq-lede">普通怪物，出现在 森林、地牢、山脉。等级范围 4-7 级。基础牌组 6 张。主要依靠牌组行动。等级提升会改动牌组或属性。</p>
...
<span>山脉</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Medusa__837.png" alt="美杜莎" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>美杜莎</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Medusa</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Medusa</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Medusa</em></span>
...
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 5、森林: 5、地牢: 5、水域: 0、火山: 0、山脉: 0</em></span>
...
</a>、<a class="dq-card-chip" href="/cards/gaze">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Gaze__534.png" alt="凝视" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>凝视</strong><small>Gaze</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Gaze__534.png" alt="凝视" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>凝视</strong>
      <small>Gaze · 行动牌 · 2 阶 · 1 行动点 / 0 法力</small>
      <em>对手手牌中每有 1 张诅咒牌，就受到 5 点伤害。抽 1 张牌。</em>
    </span>
  </span>
</a></td>
</tr>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/gaze">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Gaze__534.png" alt="凝视" loading="eager"></span></span>
  <strong>凝视</strong>
  <span class="dq-profession-card-meta">Gaze · 基础牌组 x2 / 关键行为 / 机制引用 / 机制参数</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Gaze__534.png" alt="凝视" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>凝视</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/stoneskin">
  ...
  <strong>石肤</strong>
  <span class="dq-profession-card-meta">Stoneskin · 等级变化 / 机制引用 / 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Stoneskin__294.png" alt="石肤" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>石肤</strong>
