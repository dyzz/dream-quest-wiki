...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Rich</h1>
    <p class="dq-lede">获得 30 金币。</p>
    <p class="dq-original">原文：Gain 30 gold</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Rich__50.png" alt="Rich" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Rich</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Rich</em></span>
