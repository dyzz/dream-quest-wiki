---
title: "地精"
description: "普通怪物，出现在 地牢、山脉。等级范围 1-4 级。基础牌组 1 张。主要依靠牌组行动。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>地精</h1>
    <span class="dq-original">原名：Goblin</span>
    <p class="dq-lede">普通怪物，出现在 地牢、山脉。等级范围 1-4 级。基础牌组 1 张。主要依靠牌组行动。等级提升会改动牌组或属性。</p>
...
<span>山脉</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Goblin__562.png" alt="地精" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>地精</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Goblin</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Goblin</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Goblin</em></span>
...
<span title="怪物初始化里的牌组/行动稀释参数，用于控制其节奏表现。"><strong>稀释值</strong><em>9</em></span>
...
<p><a class="dq-card-chip" href="/cards/goblin-ally">
...
<tr>
  <td>2+</td>
  <td>加入 <a class="dq-card-chip" href="/cards/goblin-ally">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/GoblinAlly__677.png" alt="地精盟友" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>地精盟友</strong><small>Goblin Ally</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/GoblinAlly__677.png" alt="地精盟友" loading="lazy"></span></span>
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-goblin-1">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/goblin">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Goblin__562.png" alt="地精" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>地精</strong><small>Goblin</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>1</em></span><span><b>HP</b><em>4</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">最低等级最终卡组</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/goblin-ally" title="地精盟友">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/GoblinAlly__677.png" alt="地精盟友" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>地精盟友</strong><small>x1 · Goblin Ally</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/GoblinAlly__677.png" alt="地精盟友" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>地精盟友</strong><small>x1 · Goblin Ally</small><em>在你的回合开始时，造成 1 点攻击伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/attack1" title="攻击（1）">
  ...
  <span class="dq-card-chip-copy"><strong>攻击（1）</strong><small>x14 · Attack (1)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>攻击（1）</strong><small>x14 · Attack (1)</small><em>造成 1 点攻击伤害。</em></span>
</span>
</a></span>
</div></td>
</tr>
<tr id="snapshot-goblin-2">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/goblin">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Goblin__562.png" alt="地精" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>地精</strong><small>Goblin</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>2</em></span><span><b>HP</b><em>7</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
...
<tr id="snapshot-goblin-3">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/goblin">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Goblin__562.png" alt="地精" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>地精</strong><small>Goblin</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>3</em></span><span><b>HP</b><em>10</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
...
<tr id="snapshot-goblin-4">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/goblin">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Goblin__562.png" alt="地精" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>地精</strong><small>Goblin</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>4</em></span><span><b>HP</b><em>15</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/goblin-ally" title="地精盟友">
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-goblin-1">查看全量怪物等级快照</a></p>
</section>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/goblin-ally">
  ...
  <strong>地精盟友</strong>
  <span class="dq-profession-card-meta">Goblin Ally · 基础牌组 x1 / 优先起手 / 关键行为 / 等级变化 / 机制引用 / 等级加入 / 机制参数</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/GoblinAlly__677.png" alt="地精盟友" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>地精盟友</strong>
