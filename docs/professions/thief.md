...
<section class="dq-section-block">
  ...
  <table class="dq-data-table">
    ...
    <tbody>
      <tr><td>基础开局</td><td>HP 15 / 蓝 0 / 手牌 2 / 行动 1 / 金币 0</td><td>7x 攻击（1） / Attack1, 2x 切割 / Slice, 1x 背刺 / Backstab</td></tr>
      <tr><td>全成就</td><td>HP 19 / 蓝 2 / 手牌 2 / 行动 1 / 金币 20</td><td>4x 攻击（1） / Attack1, 2x 攻击（2） / Attack2, 2x 切割 / Slice, 1x 背刺 / Backstab</td></tr>
    </tbody>
  </table>
  <p class="dq-note">这两行是职业基础和档案覆盖，实际开局还要套难度：Kitten 起始 HP +5，Grizzly Bear 追加 Attack1 x1，Velociraptor 追加 Attack1 x2；Kitten / Grizzly Bear 升级 HP 还会额外 +1。此职业存在已验证的全成就牌组覆盖。</p>
...
<span>Jacob, the Quick</span>
    ...
    <dl class="dq-key-value-list">
      ...
      <div title="升级时可能出现的成长选项；这些是升级奖励结构，不是 CardFinder 的单卡权重。"><dt>升级成长</dt><dd>生命增加（奖励项）、法力增加、行动点增加、金币、卡牌奖励、升级牌、删除牌</dd></div>
    </dl>
