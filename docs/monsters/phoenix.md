---
title: "凤凰"
description: "Boss，出现在 山脉、火山。等级范围 7-10 级。基础牌组 6 张。有独立技能或回合机制。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>凤凰</h1>
    <span class="dq-original">原名：Phoenix</span>
    <p class="dq-lede">Boss，出现在 山脉、火山。等级范围 7-10 级。基础牌组 6 张。有独立技能或回合机制。等级提升会改动牌组或属性。</p>
...
<span>火山</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Phoenix__444.png" alt="凤凰" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>凤凰</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Phoenix</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Phoenix</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Phoenix</em></span>
...
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 0、森林: 0、地牢: 5、水域: 0、火山: 10、山脉: 10</em></span>
...
<p>免疫火焰伤害；死亡后变为 Phoenix Egg，若同回合未击败蛋，会回到 Phoenix 形态。</p>
<p>死亡后变为 Phoenix Egg，若同回合未击败蛋，会回到 Phoenix 形态。</p>
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-phoenix-7">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/phoenix">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Phoenix__444.png" alt="凤凰" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>凤凰</strong><small>Phoenix</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>7</em></span><span><b>HP</b><em>50</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  ...
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FlameSlash2__635.png" alt="火焰斩（2）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>火焰斩（2）</strong><small>x4 · Flame Slash (2)</small></span>
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>火焰斩（2）</strong><small>x4 · Flame Slash (2)</small><em>造成 4 点火焰伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/burn" title="燃烧">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Burn__423.png" alt="燃烧" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>燃烧</strong><small>x2 · Burn</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Burn__423.png" alt="燃烧" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>燃烧</strong><small>x2 · Burn</small><em>对手开始燃烧。在其回合开始时，对手 会受到 1 点火焰伤害 直到本场战斗结束。</em></span>
</span>
</a>
...
<tr id="snapshot-phoenix-8">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/phoenix">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Phoenix__444.png" alt="凤凰" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>凤凰</strong><small>Phoenix</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>8</em></span><span><b>HP</b><em>68</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
...
<tr id="snapshot-phoenix-9">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/phoenix">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Phoenix__444.png" alt="凤凰" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>凤凰</strong><small>Phoenix</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>9</em></span><span><b>HP</b><em>87</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/flame-slash3" title="火焰斩（3）">
...
<tr id="snapshot-phoenix-10">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/phoenix">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Phoenix__444.png" alt="凤凰" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>凤凰</strong><small>Phoenix</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>10</em></span><span><b>HP</b><em>106</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  ...
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Burn2__150.png" alt="灼烧（2）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>灼烧（2）</strong><small>x2 · Burn (2)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>灼烧（2）</strong><small>x2 · Burn (2)</small><em>对手开始燃烧。在其回合开始时，对手 会受到 2 点火焰伤害 直到本场战斗结束。</em></span>
</span>
</a></span>
</div></td>
</tr>
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-phoenix-7">查看全量怪物等级快照</a></p>
</section>
...
<tr>
  <td>攻击</td>
  <td>6</td>
  <td><a class="dq-card-chip" href="/cards/flame-slash2">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FlameSlash2__635.png" alt="火焰斩（2）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>火焰斩（2）</strong><small>Flame Slash (2)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FlameSlash2__635.png" alt="火焰斩（2）" loading="lazy"></span></span>
...
</a>、<a class="dq-card-chip" href="/cards/burn">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Burn__423.png" alt="燃烧" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>燃烧</strong><small>Burn</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Burn__423.png" alt="燃烧" loading="lazy"></span></span>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/flame-slash2">
  ...
  <strong>火焰斩（2）</strong>
  <span class="dq-profession-card-meta">Flame Slash (2) · 基础牌组 x4 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FlameSlash2__635.png" alt="火焰斩（2）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>火焰斩（2）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/burn">
  ...
  <strong>燃烧</strong>
  <span class="dq-profession-card-meta">Burn · 基础牌组 x2 / 优先起手 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Burn__423.png" alt="燃烧" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>燃烧</strong>
