...
<section class="dq-section-block">
  ...
  <table class="dq-data-table">
    ...
    <tbody>
      ...
      <tr><td>自动升级 HP</td><td>职业基础最大生命 +1；实际值还会叠加难度和 FLOOR1 修正。</td></tr>
...
<section class="dq-section-block">
  ...
  <table class="dq-data-table">
    ...
    <tbody>
      <tr><td>基础开局</td><td>HP 15 / 蓝 2 / 手牌 2 / 行动 1 / 金币 0</td><td>6x 攻击（1） / Attack1, 2x 法力（1） / Mana1, 1x 吸取生命 / SiphonLife, 1x 灵魂虹吸 / SoulSiphon</td></tr>
      <tr><td>全成就</td><td>HP 19 / 蓝 4 / 手牌 2 / 行动 1 / 金币 20</td><td>6x 攻击（1） / Attack1, 2x 法力（1） / Mana1, 1x 吸取生命 / SiphonLife, 1x 灵魂虹吸 / SoulSiphon</td></tr>
    </tbody>
  </table>
...
<span>删除牌</span></div>
    ...
    <div>
      <strong>HP 成长</strong>
      <p>升级时自动最大生命 +1；实际值还会叠加难度和 FLOOR1 修正。</p>
    </div>
    <div>
...
<span>Daniel, the Dark</span>
    ...
    <dl class="dq-key-value-list">
      ...
      <div title="升级时可能出现的成长选项；这些是升级奖励结构，不是 CardFinder 的单卡权重。"><dt>升级成长</dt><dd>生命增加（奖励项）、法力增加、卡牌奖励、删除牌</dd></div>
    </dl>
