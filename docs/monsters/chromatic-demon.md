---
title: "虹彩恶魔"
description: "Boss，出现在 地牢、水域、火山、森林、山脉。等级范围 7-10 级。基础牌组 16 张。有独立技能或回合机制。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>虹彩恶魔</h1>
    <span class="dq-original">原名：Chromatic Demon</span>
    <p class="dq-lede">Boss，出现在 地牢、水域、火山、森林、山脉。等级范围 7-10 级。基础牌组 16 张。有独立技能或回合机制。等级提升会改动牌组或属性。</p>
...
<span>山脉</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/ChromaticDemon__891.png" alt="虹彩恶魔" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>虹彩恶魔</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Chromatic Demon</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>ChromaticDemon</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>ChromaticDemon</em></span>
...
<span title="怪物可在这些地形环境中生成。"><strong>生成地形</strong><em>地牢、水域、火山、森林、山脉</em></span>
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 0、森林: 5、地牢: 0、水域: 5、火山: 5、山脉: 5</em></span>
...
<tr>
  <td>6+</td>
  <td>加入 <a class="dq-card-chip" href="/cards/electrocute">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Electrocute__1012.png" alt="电刑" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>电刑</strong><small>Electrocute</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<tr>
  <td>6+</td>
  <td>加入 <a class="dq-card-chip" href="/cards/acid-rain">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidRain__397.png" alt="酸雨" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>酸雨</strong><small>Acid Rain</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<tr>
  <td>7+</td>
  <td>将 <a class="dq-card-chip" href="/cards/corrosive-slash1">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>腐蚀斩（1）</strong><small>Corrosive Slash (1)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>腐蚀斩（1）</strong>
      <small>Corrosive Slash (1) · 攻击 · 1 阶 · 0 行动点 / 0 法力</small>
      <em>造成 2 点毒性伤害。</em>
    </span>
  </span>
</a> 替换为 <a class="dq-card-chip" href="/cards/corrosive-slash3">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>腐蚀斩（3）</strong><small>Corrosive Slash (3)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>腐蚀斩（3）</strong>
      <small>Corrosive Slash (3) · 攻击 · 4 阶 · 0 行动点 / 0 法力</small>
      <em>造成 6 点毒性伤害。</em>
    </span>
  </span>
</a></td>
...
<tr>
  <td>9+</td>
  <td>加入 <a class="dq-card-chip" href="/cards/storm">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Storm__769.png" alt="风暴" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>风暴</strong><small>Storm</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<tr>
  <td>9+</td>
  <td>加入 <a class="dq-card-chip" href="/cards/blight">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Blight__788.png" alt="枯萎" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>枯萎</strong><small>Blight</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-chromatic-demon-7">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/chromatic-demon">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/ChromaticDemon__891.png" alt="虹彩恶魔" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>虹彩恶魔</strong><small>ChromaticDemon</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>7</em></span><span><b>HP</b><em>80</em></span><span><b>MP</b><em>5</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>3</em></span></span></span>
</a></td>
  ...
  <span class="dq-card-chip-copy"><strong>火焰充能</strong><small>x1 · Flame Charge</small></span>
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>火焰充能</strong><small>x1 · Flame Charge</small><em>获得 3 点法力。造成 3 点火焰伤害。</em></span>
</span>
</a>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/vile-charge" title="石之充能">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>石之充能</strong><small>x1 · Stone Charge</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>石之充能</strong><small>x1 · Stone Charge</small><em>获得 3 点法力。防止你将受到的接下来 3 点伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/static-charge" title="静电充能">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>静电充能</strong><small>x1 · Static Charge</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>静电充能</strong><small>x1 · Static Charge</small><em>获得 3 点法力。抽 下一次 法力 你牌库中的牌。</em></span>
</span>
</a>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/acid-lance" title="酸蚀长矛">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidLance__261.png" alt="酸蚀长矛" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>酸蚀长矛</strong><small>x1 · Acid Lance</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidLance__261.png" alt="酸蚀长矛" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>酸蚀长矛</strong><small>x1 · Acid Lance</small><em>对手获得 &lt;中毒 4&gt;。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/earth-shape" title="毒性形态">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>毒性形态</strong><small>x1 · Earth Shape</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>毒性形态</strong><small>x1 · Earth Shape</small><em>获得&lt;减伤 2&gt; 直到你的下个回合。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/frost-shape" title="冰霜形态">
  ...
  <span class="dq-card-chip-copy"><strong>冰霜形态</strong><small>x1 · Frost Shape</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FrostShape__80.png" alt="冰霜形态" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>冰霜形态</strong><small>x1 · Frost Shape</small><em>防止你将受到的接下来 5 点伤害。每防止 1 点伤害，就对手造成 1 点冰霜伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/fire-shape" title="火焰形态">
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/flame-slash3" title="火焰斩（3）">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FlameSlash3__965.png" alt="火焰斩（3）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>火焰斩（3）</strong><small>x1 · Flame Slash (3)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FlameSlash3__965.png" alt="火焰斩（3）" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>火焰斩（3）</strong><small>x1 · Flame Slash (3)</small><em>造成 6 点火焰伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/frost-slash3" title="冰霜斩（3）">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FrostSlash3__641.png" alt="冰霜斩（3）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>冰霜斩（3）</strong><small>x1 · Frost Slash (3)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FrostSlash3__641.png" alt="冰霜斩（3）" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>冰霜斩（3）</strong><small>x1 · Frost Slash (3)</small><em>造成 6 点冰霜伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/storm-slash3" title="风暴斩（3）">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/StormSlash3__285.png" alt="风暴斩（3）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>风暴斩（3）</strong><small>x1 · Storm Slash (3)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>风暴斩（3）</strong><small>x1 · Storm Slash (3)</small><em>造成 6 点电系伤害。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/corrosive-slash3" title="腐蚀斩（3）">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>腐蚀斩（3）</strong><small>x1 · Corrosive Slash (3)</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>腐蚀斩（3）</strong><small>x1 · Corrosive Slash (3)</small><em>造成 6 点毒性伤害。</em></span>
</span>
</a>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/electrocute" title="电刑">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Electrocute__1012.png" alt="电刑" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>电刑</strong><small>x1 · Electrocute</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Electrocute__1012.png" alt="电刑" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>电刑</strong><small>x1 · Electrocute</small><em>造成 5 点电系伤害；施放 电刑 后，你每剩余 1 点法力就额外造成 1 点电系伤害。</em></span>
</span>
</a>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/acid-rain" title="酸雨">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidRain__397.png" alt="酸雨" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>酸雨</strong><small>x1 · Acid Rain</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidRain__397.png" alt="酸雨" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>酸雨</strong><small>x1 · Acid Rain</small><em>对手获得 &lt;中毒 6&gt;。</em></span>
</span>
</a>
...
<tr id="snapshot-chromatic-demon-8">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/chromatic-demon">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/ChromaticDemon__891.png" alt="虹彩恶魔" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>虹彩恶魔</strong><small>ChromaticDemon</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>8</em></span><span><b>HP</b><em>110</em></span><span><b>MP</b><em>5</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>3</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/inspiration" title="灵感">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Inspiration__980.png" alt="灵感" loading="eager"></span></span>
...
<tr id="snapshot-chromatic-demon-9">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/chromatic-demon">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/ChromaticDemon__891.png" alt="虹彩恶魔" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>虹彩恶魔</strong><small>ChromaticDemon</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>9</em></span><span><b>HP</b><em>140</em></span><span><b>MP</b><em>5</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>3</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-card-chip-row dq-snapshot-card-row dq-snapshot-key-cards"><a class="dq-card-chip dq-counted-card-chip" href="/cards/freeze" title="冻结">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Freeze__318.png" alt="冻结" loading="eager"></span></span>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/storm" title="风暴">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Storm__769.png" alt="风暴" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>风暴</strong><small>x1 · Storm</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Storm__769.png" alt="风暴" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>风暴</strong><small>x1 · Storm</small><em>造成 10 点电系伤害。如果你至少有 30 点法力，失去 30 点法力并获得一个额外回合 在本回合之后。</em></span>
</span>
</a>
<a class="dq-card-chip dq-counted-card-chip" href="/cards/blight" title="枯萎">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Blight__788.png" alt="枯萎" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>枯萎</strong><small>x1 · Blight</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Blight__788.png" alt="枯萎" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>枯萎</strong><small>x1 · Blight</small><em>对手获得&lt;中毒 5&gt;。使对手身上的中毒层数翻倍，最多额外增加 30 层。</em></span>
</span>
</a></span>
</div></td>
</tr>
<tr id="snapshot-chromatic-demon-10">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/chromatic-demon">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/ChromaticDemon__891.png" alt="虹彩恶魔" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>虹彩恶魔</strong><small>ChromaticDemon</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>10</em></span><span><b>HP</b><em>170</em></span><span><b>MP</b><em>5</em></span><span><b>行动</b><em>2</em></span><span><b>手牌</b><em>3</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-chromatic-demon-7">查看全量怪物等级快照</a></p>
</section>
...
<tr>
  <td>攻击</td>
  <td>4</td>
  <td><a class="dq-card-chip" href="/cards/flame-slash1">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FlameSlash1__745.png" alt="火焰斩（1）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>火焰斩（1）</strong><small>Flame Slash (1)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FlameSlash1__745.png" alt="火焰斩（1）" loading="lazy"></span></span>
...
</a>、<a class="dq-card-chip" href="/cards/frost-slash1">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/FrostSlash1__375.png" alt="冰霜斩（1）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>冰霜斩（1）</strong><small>Frost Slash (1)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FrostSlash1__375.png" alt="冰霜斩（1）" loading="lazy"></span></span>
...
</a>、<a class="dq-card-chip" href="/cards/corrosive-slash1">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>腐蚀斩（1）</strong><small>Corrosive Slash (1)</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="lazy"></span></span>
...
</a>、<a class="dq-card-chip" href="/cards/acid-lance">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/AcidLance__261.png" alt="酸蚀长矛" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>酸蚀长矛</strong><small>Acid Lance</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
</a>、<a class="dq-card-chip" href="/cards/earth-shape">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>毒性形态</strong><small>Earth Shape</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>毒性形态</strong>
      <small>Earth Shape · 法术 · 5 阶 · 0 行动点 / 2 法力</small>
...
</a>、<a class="dq-card-chip" href="/cards/vile-charge">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>石之充能</strong><small>Stone Charge</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>石之充能</strong>
      <small>Stone Charge · 魔力 · 2 阶 · 0 行动点 / 0 法力</small>
      <em>获得 3 点法力。防止你将受到的接下来 3 点伤害。</em>
    </span>
  </span>
</a>、<a class="dq-card-chip" href="/cards/static-charge">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>静电充能</strong><small>Static Charge</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>静电充能</strong>
      <small>Static Charge · 魔力 · 2 阶 · 0 行动点 / 0 法力</small>
      <em>获得 3 点法力。抽 下一次 法力 你牌库中的牌。</em>
    </span>
  </span>
</a></td>
</tr>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/frost-slash1">
  ...
  <strong>冰霜斩（1）</strong>
  <span class="dq-profession-card-meta">Frost Slash (1) · 基础牌组 x1 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FrostSlash1__375.png" alt="冰霜斩（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>冰霜斩（1）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/flame-slash1">
  ...
  <strong>火焰斩（1）</strong>
  <span class="dq-profession-card-meta">Flame Slash (1) · 基础牌组 x1 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FlameSlash1__745.png" alt="火焰斩（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>火焰斩（1）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/corrosive-slash1">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="eager"></span></span>
  <strong>腐蚀斩（1）</strong>
  <span class="dq-profession-card-meta">Corrosive Slash (1) · 基础牌组 x1 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash1__253.png" alt="腐蚀斩（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>腐蚀斩（1）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/storm-slash1">
  ...
  <strong>风暴斩（1）</strong>
  <span class="dq-profession-card-meta">Storm Slash (1) · 基础牌组 x1 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/StormSlash1__451.png" alt="风暴斩（1）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>风暴斩（1）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/frost-charge">
  ...
  <strong>冰霜充能</strong>
  <span class="dq-profession-card-meta">Frost Charge · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FrostCharge__202.png" alt="冰霜充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>冰霜充能</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/flame-charge">
  ...
  <strong>火焰充能</strong>
  <span class="dq-profession-card-meta">Flame Charge · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FlameCharge__686.png" alt="火焰充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>火焰充能</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/vile-charge">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="eager"></span></span>
  <strong>石之充能</strong>
  <span class="dq-profession-card-meta">Stone Charge · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/VileCharge__69.png" alt="石之充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>石之充能</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/static-charge">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="eager"></span></span>
  <strong>静电充能</strong>
  <span class="dq-profession-card-meta">Static Charge · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/StaticCharge__1061.png" alt="静电充能" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>静电充能</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/frost-bolt">
  ...
  <strong>冰霜箭</strong>
  <span class="dq-profession-card-meta">Frost Bolt · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/FrostBolt__326.png" alt="冰霜箭" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>冰霜箭</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/fireball">
  ...
  <strong>火球</strong>
  <span class="dq-profession-card-meta">Fireball · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Fireball__167.png" alt="火球" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>火球</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/acid-lance">
  ...
  <strong>酸蚀长矛</strong>
  <span class="dq-profession-card-meta">Acid Lance · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/AcidLance__261.png" alt="酸蚀长矛" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>酸蚀长矛</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/shock">
  ...
  <strong>震击</strong>
  <span class="dq-profession-card-meta">Shock · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Shock__987.png" alt="震击" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>震击</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/corrosive-slash3">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="eager"></span></span>
  <strong>腐蚀斩（3）</strong>
  <span class="dq-profession-card-meta">Corrosive Slash (3) · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/CorrosiveSlash3__874.png" alt="腐蚀斩（3）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>腐蚀斩（3）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/frost-shape">
  ...
  <strong>冰霜形态</strong>
  <span class="dq-profession-card-meta">Frost Shape · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/earth-shape">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="eager"></span></span>
  <strong>毒性形态</strong>
  <span class="dq-profession-card-meta">Earth Shape · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/EarthShape__305.png" alt="毒性形态" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>毒性形态</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/fire-shape">
  ...
  <strong>火焰形态</strong>
  <span class="dq-profession-card-meta">Fire Shape · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/blizzard">
  ...
  <strong>暴风雪</strong>
  <span class="dq-profession-card-meta">Blizzard · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Blizzard__718.png" alt="暴风雪" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>暴风雪</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/electrocute">
  ...
  <strong>电刑</strong>
  <span class="dq-profession-card-meta">Electrocute · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Electrocute__1012.png" alt="电刑" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>电刑</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/acid-rain">
  ...
  <strong>酸雨</strong>
  <span class="dq-profession-card-meta">Acid Rain · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/AcidRain__397.png" alt="酸雨" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>酸雨</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/mana-swell">
  ...
  <strong>法力膨胀</strong>
  <span class="dq-profession-card-meta">Mana Swell · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/ManaSwell__625.png" alt="法力膨胀" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>法力膨胀</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/freeze">
  ...
  <strong>冻结</strong>
  <span class="dq-profession-card-meta">Freeze · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Freeze__318.png" alt="冻结" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>冻结</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/blight">
  ...
  <strong>枯萎</strong>
  <span class="dq-profession-card-meta">Blight · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Blight__788.png" alt="枯萎" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>枯萎</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/storm">
  ...
  <strong>风暴</strong>
  <span class="dq-profession-card-meta">Storm · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Storm__769.png" alt="风暴" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>风暴</strong>
