...
<section class="dq-section-block">
  ...
  <table class="dq-data-table">
    ...
    <tbody>
      <tr><td>基础开局</td><td>HP 15 / 蓝 2 / 手牌 2 / 行动 1 / 金币 0</td><td>5x 攻击（1） / Attack1, 3x 法力（1） / Mana1, 2x 贾斯拉的震荡电击 / JasrasJarringJolt</td></tr>
      <tr><td>全成就</td><td>HP 19 / 蓝 4 / 手牌 2 / 行动 1 / 金币 20</td><td>5x 攻击（1） / Attack1, 3x 法力（1） / Mana1, 2x 贾斯拉的震荡电击 / JasrasJarringJolt</td></tr>
    </tbody>
  </table>
...
<span>Uther, the Uncontrolled</span>
    ...
    <dl class="dq-key-value-list">
      ...
      <div title="升级时可能出现的成长选项；这些是升级奖励结构，不是 CardFinder 的单卡权重。"><dt>升级成长</dt><dd>生命增加（奖励项）、法力增加、卡牌奖励、升级牌、删除牌</dd></div>
    </dl>
