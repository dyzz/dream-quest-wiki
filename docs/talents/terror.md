...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Terror</h1>
    <p class="dq-lede">对手手牌上限减少 1。</p>
    <p class="dq-original">原文：Your opponents' hand sizes are reduced by 1</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Terror__86.png" alt="Terror" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Terror</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Terror</em></span>
...
<tr>
  ...
  <td>能力文本：对手手牌上限减少 1。（Opponents have one fewer card）</td>
</tr>
<tr>
  <td>ApplyToPlayer</td>
  <td>降低对手手牌</td>
  <td>Game.OtherPlayer + Player.hand_size_field_0xac</td>
  <td>delta：-1</td>
</tr>
  </tbody>
</table>
