---
title: "梦境之主"
description: "Dream Quest 最终 Boss 怪物图鉴入口。"
---
...
<span title="最终 Boss 的运行时类名。"><strong>内部类</strong><em>FinalBoss</em></span>
...
<span title="FinalBoss.BuildAttributes 固定写入。"><strong>等级</strong><em>10</em></span>
<span title="FinalBoss.BuildAttributes 固定写入。"><strong>生命</strong><em>1000</em></span>
<span title="FinalBoss.BuildAttributes 固定写入。"><strong>行动点</strong><em>5</em></span>
<span title="FinalBoss.BuildAttributes 固定写入。"><strong>每回合抽牌</strong><em>5</em></span>
<span title="FinalBoss.BuildAttributes 固定写入。"><strong>法力</strong><em>40</em></span>
<span title="Lord 不走普通 MonsterData 选择权重。"><strong>普通权重表</strong><em>不参与</em></span>
</div>
</section>
