---
title: "鬼火"
description: "普通怪物，出现在 森林、墓穴、水域。等级范围 5-7 级。基础牌组 6 张。有独立技能或回合机制。等级提升会改动牌组或属性。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>鬼火</h1>
    <span class="dq-original">原名：Wisp</span>
    <p class="dq-lede">普通怪物，出现在 森林、墓穴、水域。等级范围 5-7 级。基础牌组 6 张。有独立技能或回合机制。等级提升会改动牌组或属性。</p>
...
<span>水域</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Wisp__474.png" alt="鬼火" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>鬼火</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Wisp</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Wisp</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Wisp</em></span>
...
<span title="怪物可在这些地形环境中生成。"><strong>生成地形</strong><em>森林、墓穴、水域</em></span>
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 0、森林: 10、地牢: 0、水域: 5、火山: 0、山脉: 10</em></span>
...
<p>物理免疫；<a class="dq-card-chip" href="/cards/discharge">
  ...
  <span class="dq-card-chip-copy"><strong>放电</strong><small>Discharge</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Discharge__734.png" alt="放电" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>放电</strong>
      <small>Discharge · 法术 · 6 阶 · 0 行动点 / 0 法力</small>
      <em>施放 放电 后，你每剩余 1 点法力就造成 1 点电系伤害。失去物理免疫直到你的下个回合。</em>
    </span>
  </span>
</a> 按当前法力造成伤害。</p>
</div>
...
</a> 替换为 <a class="dq-card-chip" href="/cards/wisdom">
...
</a>、<a class="dq-card-chip" href="/cards/discharge">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Discharge__734.png" alt="放电" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>放电</strong><small>Discharge</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Discharge__734.png" alt="放电" loading="lazy"></span></span>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/mana3">
  ...
  <strong>法力（3）</strong>
  <span class="dq-profession-card-meta">Mana (3) · 基础牌组 x3 / 等级移出</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Mana3__658.png" alt="法力（3）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>法力（3）</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/wisdom">
  ...
  <strong>智慧</strong>
  <span class="dq-profession-card-meta">Wisdom · 等级加入</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Wisdom__574.png" alt="智慧" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>智慧</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/discharge">
  <span class="dq-deck-card-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/Discharge__734.png" alt="放电" loading="eager"></span></span>
  <strong>放电</strong>
  <span class="dq-profession-card-meta">Discharge · 基础牌组 x1</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/Discharge__734.png" alt="放电" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>放电</strong>
