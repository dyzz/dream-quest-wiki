...
<tr>
  ...
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/PenaltyWard30__543.png" alt="防护惩罚（30）" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>防护惩罚（30）</strong><small>Penalty Ward30</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
