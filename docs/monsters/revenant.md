---
title: "亡魂"
description: "普通怪物，出现在 墓穴、地牢。等级范围 7-10 级。基础牌组 4 张。有独立技能或回合机制。等级提升没有解析到额外牌组改动。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>亡魂</h1>
    <span class="dq-original">原名：Revenant</span>
    <p class="dq-lede">普通怪物，出现在 墓穴、地牢。等级范围 7-10 级。基础牌组 4 张。有独立技能或回合机制。等级提升没有解析到额外牌组改动。</p>
...
<span>地牢</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Revenant__776.png" alt="亡魂" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>亡魂</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Revenant</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>Revenant</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>Revenant</em></span>
...
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 10、森林: 0、地牢: 5、水域: 0、火山: 3、山脉: 0</em></span>
...
<p>第一次死亡后会清理诅咒、洗牌、抽牌并以更强形态返回；第一形态有无敌标记。</p>
</div>
</section>
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-revenant-7">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/revenant">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Revenant__776.png" alt="亡魂" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>亡魂</strong><small>Revenant</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>7</em></span><span><b>HP</b><em>40</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
...
<a class="dq-card-chip dq-counted-card-chip" href="/cards/siphon-life" title="吸取生命">
  ...
  <span class="dq-card-chip-copy"><strong>吸取生命</strong><small>x2 · Drain Life</small></span>
  <span class="dq-snapshot-card-preview" aria-hidden="true">
  <span class="dq-snapshot-card-preview-art"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/SiphonLife__95.png" alt="吸取生命" loading="eager"></span></span>
  <span class="dq-snapshot-card-preview-copy"><strong>吸取生命</strong><small>x2 · Drain Life</small><em>造成 4 点&lt;穿透&gt;伤害。回复 4 点生命。</em></span>
</span>
</a>
...
<tr id="snapshot-revenant-8">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/revenant">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Revenant__776.png" alt="亡魂" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>亡魂</strong><small>Revenant</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>8</em></span><span><b>HP</b><em>55</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
...
<tr id="snapshot-revenant-9">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/revenant">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Revenant__776.png" alt="亡魂" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>亡魂</strong><small>Revenant</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>9</em></span><span><b>HP</b><em>70</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-muted-chip">无新增关键牌</span>
...
<tr id="snapshot-revenant-10">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/revenant">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/Revenant__776.png" alt="亡魂" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>亡魂</strong><small>Revenant</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>10</em></span><span><b>HP</b><em>85</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-muted-chip">无新增关键牌</span>
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-revenant-7">查看全量怪物等级快照</a></p>
</section>
...
<tr>
  <td>行动牌</td>
  <td>2</td>
  <td><a class="dq-card-chip" href="/cards/vampire-bite2">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VampireBite2__373.png" alt="吸血鬼之咬（2）" loading="eager"></span></span>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/siphon-life">
  ...
  <strong>吸取生命</strong>
  <span class="dq-profession-card-meta">Drain Life · 基础牌组 x2</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/SiphonLife__95.png" alt="吸取生命" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>吸取生命</strong>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/vampire-bite2">
  ...
  <strong>吸血鬼之咬（2）</strong>
  <span class="dq-profession-card-meta">Vampire Bite (2) · 基础牌组 x2</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/VampireBite2__373.png" alt="吸血鬼之咬（2）" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>吸血鬼之咬（2）</strong>
