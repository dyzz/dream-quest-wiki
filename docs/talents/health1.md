...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Healthy</h1>
    <p class="dq-lede">获得 5 点生命上限。</p>
    <p class="dq-original">原文：Gain 5 health</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Health1__557.png" alt="Healthy" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Health1</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Healthy</em></span>
