...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Quick</h1>
    <p class="dq-lede">获得 1 点行动点。</p>
    <p class="dq-original">原文：Gain 1 action</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Action1__765.png" alt="Quick" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Action1</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Quick</em></span>
