...
<section class="dq-profession-hero dq-feature-hero">
  <div>
    ...
    <h1>Smart</h1>
    <p class="dq-lede">每回合额外抽 1 张牌。</p>
    <p class="dq-original">原文：Draw one additional card each turn</p>
  ...
  <div class="dq-profession-portrait dq-feature-portrait">
    <img src="/assets/extracted/textures/by_container/resources/Card1__544.png" alt="Smart" loading="lazy">
  </div>
</section>
...
<span title="DungeonTalentList 中的内部名称。"><strong>内部名称</strong><em>Card1</em></span>
<span title="游戏内显示名称。"><strong>显示名</strong><em>Smart</em></span>
