---
title: "吸血蝙蝠"
description: "普通怪物，出现在 地牢、山脉、森林。等级范围 1-4 级。基础牌组 3 张。主要依靠牌组行动。等级提升没有解析到额外牌组改动。"
---
...
<section class="dq-profession-hero dq-monster-hero">
  <div>
    ...
    <h1>吸血蝙蝠</h1>
    <span class="dq-original">原名：Vampire Bat</span>
    <p class="dq-lede">普通怪物，出现在 地牢、山脉、森林。等级范围 1-4 级。基础牌组 3 张。主要依靠牌组行动。等级提升没有解析到额外牌组改动。</p>
...
<span>森林</span>
  ...
  <div class="dq-profession-portrait dq-monster-portrait">
    <img src="/assets/extracted/textures/by_container/resources/VampireBat__787.png" alt="吸血蝙蝠" loading="lazy">
  </div>
</section>
...
<span title="wiki 中使用的统一中文名称。"><strong>中文名</strong><em>吸血蝙蝠</em></span>
<span title="游戏原始显示名。"><strong>英文名</strong><em>Vampire Bat</em></span>
<span title="怪物在解析数据中的内部引用名称。"><strong>怪物 ID</strong><em>VampireBat</em></span>
<span title="反编译类名，通常用于和代码中的怪物实现对应。"><strong>类名</strong><em>VampireBat</em></span>
...
<span title="怪物可在这些地形环境中生成。"><strong>生成地形</strong><em>地牢、山脉、森林</em></span>
<span title="不同地形中的生成权重；0 表示通常不在该环境自然生成。"><strong>地形权重</strong><em>墓穴: 10、森林: 0、地牢: 5、水域: 0、火山: 0、山脉: 5</em></span>
...
<p><a class="dq-card-chip" href="/cards/vampire-bite">
...
<p>起手优先牌：<a class="dq-card-chip" href="/cards/vampire-bite">
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VampireBite__1027.png" alt="吸血鬼之咬" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>吸血鬼之咬</strong><small>Vampire Bite</small></span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/VampireBite__1027.png" alt="吸血鬼之咬" loading="lazy"></span></span>
...
<table class="dq-data-table dq-snapshot-table">
  ...
  <tbody>
<tr id="snapshot-vampire-bat-1">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/vampire-bat">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/VampireBat__787.png" alt="吸血蝙蝠" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>吸血蝙蝠</strong><small>VampireBat</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>1</em></span><span><b>HP</b><em>4</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  ...
  <span class="dq-card-chip-thumb"><span class="dq-game-card dq-game-card-deck"><img src="/assets/extracted/textures/by_container/resources/VampireBite__1027.png" alt="吸血鬼之咬" loading="eager"></span></span>
  <span class="dq-card-chip-copy"><strong>吸血鬼之咬</strong><small>x3 · Vampire Bite</small></span>
  ...
  <span class="dq-snapshot-card-preview-copy"><strong>吸血鬼之咬</strong><small>x3 · Vampire Bite</small><em>造成 2 点攻击伤害。回复 2 点生命。</em></span>
</span>
</a>
...
<tr id="snapshot-vampire-bat-2">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/vampire-bat">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/VampireBat__787.png" alt="吸血蝙蝠" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>吸血蝙蝠</strong><small>VampireBat</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>2</em></span><span><b>HP</b><em>7</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
...
<tr id="snapshot-vampire-bat-3">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/vampire-bat">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/VampireBat__787.png" alt="吸血蝙蝠" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>吸血蝙蝠</strong><small>VampireBat</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>3</em></span><span><b>HP</b><em>10</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-muted-chip">无新增关键牌</span>
...
<tr id="snapshot-vampire-bat-4">
  <td class="dq-snapshot-monster-cell"><a class="dq-snapshot-monster" href="/monsters/vampire-bat">
  <span class="dq-snapshot-monster-thumb"><img src="/assets/extracted/textures/by_container/resources/VampireBat__787.png" alt="吸血蝙蝠" loading="lazy"></span>
  <span class="dq-snapshot-monster-copy"><strong>吸血蝙蝠</strong><small>VampireBat</small><span class="dq-snapshot-stat-row"><span><b>等级</b><em>4</em></span><span><b>HP</b><em>15</em></span><span><b>MP</b><em>0</em></span><span><b>行动</b><em>1</em></span><span><b>手牌</b><em>2</em></span></span></span>
</a></td>
  <td class="dq-long-cell dq-snapshot-deck-cell"><div class="dq-snapshot-key-card">
  <span class="dq-snapshot-key-label">本等级新增牌</span>
  <span class="dq-muted-chip">无新增关键牌</span>
  ...
  <p><a href="/assets/data/monster-level-snapshots-incremental.html#snapshot-vampire-bat-1">查看全量怪物等级快照</a></p>
</section>
...
<a class="dq-profession-card-link dq-profession-card-entry" href="/cards/vampire-bite">
  ...
  <strong>吸血鬼之咬</strong>
  <span class="dq-profession-card-meta">Vampire Bite · 基础牌组 x3 / 优先起手 / 关键行为 / 机制引用 / 机制参数</span>
  <span class="dq-card-hover-preview" aria-hidden="true">
    <span class="dq-card-hover-art"><span class="dq-game-card dq-game-card-hover"><img src="/assets/extracted/textures/by_container/resources/VampireBite__1027.png" alt="吸血鬼之咬" loading="lazy"></span></span>
    <span class="dq-card-hover-copy">
      <strong>吸血鬼之咬</strong>
